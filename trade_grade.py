...
EDGE = {
    ...
    # 💨 тонкий памп (90д, 25.07: рост >2.2× медианы на объёме < медианы,
    # сетка SHORT −10/+5/96ч; случайный шорт того же окна: 39.8 / −0.22)
    ('thin_pump', 'SHORT', 'ВСЕ'): (581, 51.3, 1.36, 27.7),
}
