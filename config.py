...
BOTS = [
    ...
    # 🎓 Академия — самообучаемая модель (ночной пересчёт, 17.09)
    {"id": "academy", "label": "🎓 Академия", "category": "crypto"},
    # 💎 Лайв — симуляция реальной торговли BingX (top-EV срез, 18.09)
    {"id": "live", "label": "💎 Лайв", "category": "crypto"},
