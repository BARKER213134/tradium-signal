...
def analyze(ctx):
    ...
    prompt = (
        ...
        + '₿ Режим BTC (просадка от 30д-макс, бэктест коррекции 20.05→08.07): у максимума — шорты бесполезны (+0.1), работают лонги; коррекция −8..−15% — шорты сильны (+3.9, WR 63: supertrend_daily/mtf, volume_surge, second_flip, shark), лонги от дна умирают (🥇 −0.2); капитуляция ≤−15% — снова лонги (whale/volume_surge +4). Шорты в лайв — только в коррекции. ЛОНГИ ТОЛЬКО ОТ ДНА (школа 23.09): одобренные лонги от дна WR 86 +7.4 (×2: WR 93 +8.2), не у дна (зелёная серия ≥5 или широта >60) WR 44 +1.2 (×2: WR 41 +0.8), на развороте WR 15 −2.9 — в лайв такие не берём. ')
